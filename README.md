...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/anton2423865)

</div>

## 🎯 Who I Am

I'm a **Computer Science Engineering graduate from APJ Abdul Kalam Technological University (2022–2026)** based in Kerala, India, building my career in **Data Analytics**.

I enjoy working with data to uncover patterns, generate insights, and communicate findings that support **data-driven decision-making**.
...
Analyzed student performance data using **Python, Pandas, NumPy, Matplotlib, and Seaborn** to identify patterns and relationships between demographic and academic factors.

**Key areas:**
- Data cleaning and preprocessing
- Exploratory data analysis
- Demographic analysis
- Visualization of academic trends
- Data-driven insights

### 🚲 Bike Sales Analysis

Analyzed bike sales data using **Excel and Power BI** to explore customer behavior, regional trends, and purchasing patterns.
